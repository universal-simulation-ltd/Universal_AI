...
<div class="customise">
  ...
  <section>
    ...
    <p class="hint">
      Off keeps the app fully offline and private. When on, the <b>Online</b>
      button on answers can search the web — <b>Wikipedia</b> or <b>DuckDuckGo</b>
      (more to come) — and opens straight away without the extra “open link?”
